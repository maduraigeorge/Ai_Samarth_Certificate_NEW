...
// --- DATABASE CONNECTION ---
// TODO: Replace these placeholders with your actual MySQL credentials
const db = mysql.createPool({
  host: 'localhost',      // e.g., '127.0.0.1' or your hosting IP
  user: 'root',           // your database username
  password: 'password',   // your database password
  database: 'webinar_db', // your database name
...
db.getConnection((err, connection) => {
  if (err) {
    ...
    // Create Table if it doesn't exist (Helper for first run)
